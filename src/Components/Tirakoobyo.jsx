...
function TiroKoobyo(){
    const [countTabaruc,setcountTabaruc] = useState()
    const [countUsers,setcountUsers] = useState()
      const [TotalTabaruc,setTotalTabaruc] = useState()
    const {state} = Auth()

    useEffect(() => {
        setcountTabaruc(state.CountTabaruc)
        setcountUsers(state.CountUsres)
        setTotalTabaruc(state.TotalTabaruc)
    },[state.CountTabaruc,state.CountUsres,state.TotalTabaruc])
    return (
            ...
            <div className="haye">
                ...
                <div className="card Mashruucyo">
                    ...
                    <div className="qoraal">
                        <h2><i className="fa-solid fa-sack-dollar"></i> {TotalTabaruc && TotalTabaruc[0].Lacagta}  <span className="Tirokoob_titels">$ Dollar</span></h2>
                        <p>
                            Tabruca sanadlaha ah ee ee shabakada ixsaan waxa uu gaadhay halkii ugu saraysay sanakada 2023.
                        </p>
                    </div>
                </div>
                ...
                <div className="icon">
                    ...
                    <div className="qoraal">
                        <h2><i className="fa-solid fa-hand-holding-heart"></i> {countTabaruc} <span className="Tirokoob_titels">Deeq Bixiye</span></h2>
                        <p>
                            Tirada guud ee dadka Tabarucyadooda ku bixiyay shabakada  ixsaan intii ay shaqaynaysay
                        </p>
                    </div>
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd"><path d="M0 0h24v24H0z"></path><path d="M17.272 8.685a1 1 0 111.456-1.37l4 4.25a1 1 0 010 1.37l-4 4.25a1 1 0 01-1.456-1.37l3.355-3.565-3.355-3.565zm-10.544 0L3.373 12.25l3.355 3.565a1 1 0 01-1.456 1.37l-4-4.25a1 1 0 010-1.37l4-4.25a1 1 0 011.456 1.37z" fill="#335EEA"></path><rect fill="#335EEA" opacity=".3" transform="rotate(15 12 12)" x="11" y="4" width="2" height="16" rx="1"></rect></g></svg>
                    ...
                    <div className="qoraal">
                        <h2><i className="fa-solid fa-users"></i> {countUsers} <span className="Tirokoob_titels">Isticmaale</span></h2>
                        <p>
                        isticmaalayaasha shabakada ixsaan si rasmiya akoon ugu leh wax ku dhawyahay 8 kun qof sanadkan 2023.
                        </p>
                    </div>
