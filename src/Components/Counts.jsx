        ...
        <div className="Counts">
            <div className="haye">
                ...
                <div className="qayb midig">
                    <img src="/Images/illustration-3.png" alt="dhash" />
                </div>
                <div className="qayb bidix">
                    <div className="bidix_decr">
                    <h2>La jaan qaabka casriga ah  
                    <span> isticmaal  shabakada ixsaan .</span></h2>
                    <p>
                        Waa qaab wax bixin casriya oo aad ilaahay ugu dhawaanayso taas oo mar walba kugu xidhaysa dad walaalahaa ah oo bahan.                    </p>
                    </div>
